...
async def run_test():
    ...
    try:
        ...
        # Select Spanish language and save the preference.
        ...
        # Enter a natural language query in Spanish in the chat input and submit it.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div[2]/main/div/div/section[2]/div[2]/div/div[2]/form/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('¿Cuál es la capital de España?')
